...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mt-3(data-aos="fade-up") Al finalizar este tema el aprendiz estará en capacidad de crear diversos aspectos en la plataforma Docker, además de construir, ejecutar, modificar y transformar contenedores Docker, a partir de imágenes locales, así como compartir una imagen local en el repositorio en la nube Docker Hub.
